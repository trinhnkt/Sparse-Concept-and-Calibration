...
* **File chỉnh sửa:** [paper/main.tex](file:///c:/TRINH/P0/p0-sparse-calibration-kt/paper/main.tex) và [paper/main_submit_candidate.tex](file:///c:/TRINH/P0/p0-sparse-calibration-kt/paper/main_submit_candidate.tex) (Dòng 70–73).
...
* **File chỉnh sửa:** [src/generate_pipeline_diagram.py](file:///c:/TRINH/P0/p0-sparse-calibration-kt/src/generate_pipeline_diagram.py) (Dòng 39).
* **Nội dung thay đổi:** Sửa nhãn `"Model Training (BKT, DKT, SimpleKT)"` thành `"Model Training (IRT, DKT, SimpleKT)"`.
* **Kết quả:** Đã chạy lại script nguồn để tái tạo hình ảnh PDF vector chuẩn hóa tại [paper/figures/figure1_pipeline.pdf](file:///c:/TRINH/P0/p0-sparse-calibration-kt/paper/figures/figure1_pipeline.pdf). Biểu đồ mới đã hiển thị chính xác tên baseline `IRT` thay cho `BKT`.

### 1.3. Chỉnh sửa Note/Caption của Figure 3
* **File chỉnh sửa:** [paper/sections/04_experiments.tex](file:///c:/TRINH/P0/p0-sparse-calibration-kt/paper/sections/04_experiments.tex) (Dòng 67 và Dòng 84).
...
* **File chỉnh sửa:** 
  - [paper/sections/04_experiments.tex](file:///c:/TRINH/P0/p0-sparse-calibration-kt/paper/sections/04_experiments.tex) (Dòng 94).
  - [scripts/make_updated_latex_tables.py](file:///c:/TRINH/P0/p0-sparse-calibration-kt/scripts/make_updated_latex_tables.py) (Dòng 723 - Note của Table VI).
...
* **File chỉnh sửa:** [paper/sections/04_experiments.tex](file:///c:/TRINH/P0/p0-sparse-calibration-kt/paper/sections/04_experiments.tex) (Dòng 54).
...
* **File chỉnh sửa:** [paper/sections/04_experiments.tex](file:///c:/TRINH/P0/p0-sparse-calibration-kt/paper/sections/04_experiments.tex) (Dòng 57–58, ngay trước Table V).
...
* **File chỉnh sửa:** [scripts/make_updated_latex_tables.py](file:///c:/TRINH/P0/p0-sparse-calibration-kt/scripts/make_updated_latex_tables.py) (Dòng 744).
...
* **Kết quả:** Đã chạy lại script sinh bảng LaTeX để cập nhật trực tiếp vào file [table_vii_threshold_sensitivity_updated.tex](file:///c:/TRINH/P0/p0-sparse-calibration-kt/paper/tables/table_vii_threshold_sensitivity_updated.tex) and [tableA1_sensitivity.tex](file:///c:/TRINH/P0/p0-sparse-calibration-kt/paper/tables/tableA1_sensitivity.tex).

### 1.8. Thêm Câu phối hợp với Công trình của NCS Tuấn vào Section V.B
* **File chỉnh sửa:** [paper/sections/05_discussion_limitations.tex](file:///c:/TRINH/P0/p0-sparse-calibration-kt/paper/sections/05_discussion_limitations.tex) (Dòng 9).
...
* **File chỉnh sửa:** [paper/sections/04_experiments.tex](file:///c:/TRINH/P0/p0-sparse-calibration-kt/paper/sections/04_experiments.tex) (Dòng 40).
...
2. **Compile PDF thành công:** Tệp preview PDF vector chất lượng cao đã được cập nhật và biên dịch thành công tại:
   👉 **[paper/P0_16_consistency_fixed.pdf](file:///c:/TRINH/P0/p0-sparse-calibration-kt/paper/P0_16_consistency_fixed.pdf)**
