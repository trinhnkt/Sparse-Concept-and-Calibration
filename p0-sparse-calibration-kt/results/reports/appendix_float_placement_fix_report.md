...
* **Cách khắc phục:**
  ...
  - Thêm lệnh chặn float `\FloatBarrier` ngay sau Table XI trong Appendix D (tệp [appendix_a_sensitivity.tex](file:///c:/TRINH/P0/p0-sparse-calibration-kt/paper/appendix/appendix_a_sensitivity.tex)).
