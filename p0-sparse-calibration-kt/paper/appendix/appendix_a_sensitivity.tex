...
Detailed calibration results by frequency stratum for the learner-based split are reported in Table~X. Additionally, the corresponding detailed calibration results for the temporal split, which serve as the numerical basis for the reliability diagrams in Figure~3, are reported in Table~\ref{tab:calib_temporal}.
