...
Detailed calibration results by frequency stratum for the learner-based split are reported in Table~\ref{tab:calib}. The corresponding temporal calibration breakdowns, computed after the label-alignment correction and used as the numerical basis for Figure 3, are reported in Table~\ref{tab:calib_temporal}.

\input{tables/table_v_calibration_by_bucket_updated}
\input{tables/tableA_calibration_by_bucket_temporal}
\clearpage
\twocolumn
