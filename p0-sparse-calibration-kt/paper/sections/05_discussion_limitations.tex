...
\label{sec:threats}
We analyze the threats to the validity of our diagnostic protocol across four standard dimensions:
\begin{itemize}
    ...
    \item \textbf{Temporal Alignment Validity:} Our temporal-split audit identified a prediction--label alignment issue in part of the evaluation pipeline. We detected it using warm-cohort AUC and prediction--label correlation checks, then re-ran the affected diagnostics after correction. Therefore, temporal cold-start results are interpreted together with sanity checks to distinguish genuine concept-level cold-start difficulty from alignment artifacts.
