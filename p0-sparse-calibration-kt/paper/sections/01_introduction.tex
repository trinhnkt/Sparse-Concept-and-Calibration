...
The remainder of this paper is organized as follows. Section~\ref{sec:related} reviews KT evaluation, sparse-concept analysis, and calibration. Section~\ref{sec:protocol} presents the diagnostic protocol. Section~\ref{sec:experiments} describes the experimental design and placeholder result tables to be filled after running the pipeline. Section~\ref{sec:discussion} discusses implications and limitations.
