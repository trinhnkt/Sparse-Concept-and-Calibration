...
\begin{itemize}
    ...
    \item \textbf{P4. Leakage-audited Reporting:} No diagnostic result is considered complete or valid unless accompanied by an explicit, verifiable leakage-control check. This is formalized through our seven-channel leakage checklist (L1--L7), which enforces strict documentation of data splits, preprocessing scopes, and parameter configurations.
\end{itemize}
