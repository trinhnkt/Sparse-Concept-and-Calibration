...
\begin{itemize}
    ...
    \item \textbf{Code availability:} The reproducible code, protocol checklist, and reporting templates will be available upon acceptance at an anonymous repository link.
