...
Detailed calibration results by frequency stratum for the learner-based split are reported in Table~\ref{tab:calib}. The corresponding temporal calibration breakdowns, computed after the label-alignment correction documented in Appendix F and used as the numerical basis for Figure 3, are reported in Table~\ref{tab:temporal_calibration_breakdown}.

\input{tables/table_v_calibration_by_bucket_updated}
\input{tables/table_xi_temporal_calibration_breakdown}
\clearpage
