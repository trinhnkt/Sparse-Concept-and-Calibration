...
def main():
    ...
    ax.text(0.5, 0.235, "• Cold-start Subsets: Strict ($f_{\\mathrm{train}}=0$), $k$-shot subsets ($f_{\\mathrm{train}} \\leq 5$ or $\\leq 10$) & Warm cohorts", ha='center', va='center', **font_body)
