...
def main():
    print("Generating Beautiful Final Wording Polished Vector PDF of the Paper Candidate...")
    ...
    notice_text = (
        "FINAL WORDING CANDIDATE: This PDF represents the mathematically and structurally audited P0 final manuscript.\n"
    ...
    out_path = Path("paper/P0_wording_final.pdf")
    out_path.parent.mkdir(parents=True, exist_ok=True)
    plt.savefig(out_path, format='pdf', bbox_inches='tight')
    plt.close()
    
    print(f"Final Wording Vector PDF Candidate successfully generated at: {out_path}")
