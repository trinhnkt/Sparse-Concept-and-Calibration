...
def main():
    ...
    schematic_steps = [
        ...
        "2. APPENDIX B: TEMPORAL SPLIT PERFORMANCE  -->  [TABLE VIII & IX: Strata Performance]  -->  [FloatBarrier] (PASS: Kept inside B)",
        "3. APPENDIX C: DETAILED CALIBRATION  -->  [TABLE X: Calibration Breakdown]  -->  [FloatBarrier] (PASS: Forced before Appendix D)",
        "4. APPENDIX D: DIAGNOSTIC INTERPRETATION GUIDE  -->  [TABLE XI: Guide]  -->  [FloatBarrier] (PASS: Clean flow)",
    ...
    checklist_text = (
        ...
        "✔ LaTeX compilation: Placeins package package verified, all FloatBarriers integrated successfully."
    )
