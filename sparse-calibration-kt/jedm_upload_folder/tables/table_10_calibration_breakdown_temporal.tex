...
\vspace{1ex}
{\scriptsize \textbf{Note:} Reliability flags (R/L/I) follow Section 3.5. These values serve as the numerical basis for Figure 3. Very Sparse excludes Strict Cold-start KCs; Strict Cold-start is reported separately where applicable. IRT calibration should be interpreted jointly with discrimination and Brier resolution: under learner-based splits, IRT behaves as a base-rate reference for unseen learners (Section 4.2); under temporal splits, it recovers non-zero resolution because learners are observed during training.\par}
