...
def main():
    print("Generating Beautiful Enhanced Vector PDF of the Final Paper Candidate...")
    ...
    notice_text = (
        "ENHANCED VALIDATION CANDIDATE: This PDF represents the mathematically and structurally audited P0 final manuscript.\n"
    ...
    out_path = Path("paper/P0_submit_candidate.pdf")
    out_path.parent.mkdir(parents=True, exist_ok=True)
    plt.savefig(out_path, format='pdf', bbox_inches='tight')
    plt.close()
    
    print(f"Enhanced Vector PDF Candidate successfully generated at: {out_path}")
