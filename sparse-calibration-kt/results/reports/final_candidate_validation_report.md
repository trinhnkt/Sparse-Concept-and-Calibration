...
2. **Audited PDF Candidate:** [P0_final_candidate.pdf](file:///c:/TRINH/Sparse-Concept and Calibration/sparse-calibration-kt/paper/P0_final_candidate.pdf)
3. **Audit Reports:**
   - ECE/Brier mathematical audit: [ece_brier_bkt_audit_report.md](file:///c:/TRINH/Sparse-Concept and Calibration/sparse-calibration-kt/results/reports/ece_brier_bkt_audit_report.md)
   - Event consistency audit: [table4_table5_event_consistency_report.md](file:///c:/TRINH/Sparse-Concept and Calibration/sparse-calibration-kt/results/reports/table4_table5_event_consistency_report.md)
