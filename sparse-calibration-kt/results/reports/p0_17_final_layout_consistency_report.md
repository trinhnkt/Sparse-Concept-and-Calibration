...
*   **Các file cập nhật:**
    - [make_updated_latex_tables.py](file:///c:/TRINH/Sparse-Concept and Calibration/sparse-calibration-kt/scripts/make_updated_latex_tables.py) (Dòng 496).
    - Đã chạy lại script để tái tạo hoàn chỉnh các tệp:
      - [table_v_calibration_by_bucket_updated.tex](file:///c:/TRINH/Sparse-Concept and Calibration/sparse-calibration-kt/paper/tables/table_v_calibration_by_bucket_updated.tex)
      - [table_v_calibration_with_reliability.tex](file:///c:/TRINH/Sparse-Concept and Calibration/sparse-calibration-kt/paper/tables/table_v_calibration_with_reliability.tex)
      - [table5_calibration_per_bucket.tex](file:///c:/TRINH/Sparse-Concept and Calibration/sparse-calibration-kt/paper/tables/table5_calibration_per_bucket.tex)
      - [tableA_calibration_by_bucket_full.tex](file:///c:/TRINH/Sparse-Concept and Calibration/sparse-calibration-kt/paper/tables/tableA_calibration_by_bucket_full.tex)
...
*   **File chỉnh sửa:** [04_experiments.tex](file:///c:/TRINH/Sparse-Concept and Calibration/sparse-calibration-kt/paper/sections/04_experiments.tex) (Dòng 14).
...
*   **File chỉnh sửa:** [04_experiments.tex](file:///c:/TRINH/Sparse-Concept and Calibration/sparse-calibration-kt/paper/sections/04_experiments.tex) (Dòng 67 và 84).
...
*   **File chỉnh sửa:** [04_experiments.tex](file:///c:/TRINH/Sparse-Concept and Calibration/sparse-calibration-kt/paper/sections/04_experiments.tex) (Dòng 61).
*   **Văn bản mới (Hedging):**
...
*   **File chỉnh sửa:** [04_experiments.tex](file:///c:/TRINH/Sparse-Concept and Calibration/sparse-calibration-kt/paper/sections/04_experiments.tex) (Dòng 30).
...
*   **Hành động thực hiện:**
    ...
    - Tại phụ lục [appendix_a_sensitivity.tex](file:///c:/TRINH/Sparse-Concept and Calibration/sparse-calibration-kt/paper/appendix/appendix_a_sensitivity.tex), bổ sung `\section{Detailed Calibration Results}` với nhãn `\label{app:calibration_performance}` làm **Appendix C**. Bảng được chèn trực tiếp vào phần này dưới dạng `Table~\ref{tab:calib}` (sẽ biên dịch thành Table XI do là bảng thứ 11 trong tài liệu).
...
2.  **Compile PDF thành công:** Đã xuất bản vẽ PDF candidate kiểm tra chất lượng cao định dạng vector phản ánh cấu trúc mới tại:
    👉 **[paper/P0_17_final_layout_consistency_fixed.pdf](file:///c:/TRINH/Sparse-Concept and Calibration/sparse-calibration-kt/paper/P0_17_final_layout_consistency_fixed.pdf)**
