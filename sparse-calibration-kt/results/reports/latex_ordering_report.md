...
*   **Location:** [paper/main.tex](file:///c:/TRINH/Sparse-Concept and Calibration/sparse-calibration-kt/paper/main.tex#L22)
...
*   **Location:** [paper/main.tex](file:///c:/TRINH/Sparse-Concept and Calibration/sparse-calibration-kt/paper/main.tex#L89-L96)
...
1.  **Cold-start Results (Table VI):**
    *   **Location:** [paper/sections/04_experiments.tex](file:///c:/TRINH/Sparse-Concept and Calibration/sparse-calibration-kt/paper/sections/04_experiments.tex#L89)
...
2.  **Sensitivity Analysis (Table VII):**
    *   **Location:** [paper/appendix/appendix_a_sensitivity.tex](file:///c:/TRINH/Sparse-Concept and Calibration/sparse-calibration-kt/paper/appendix/appendix_a_sensitivity.tex#L5)
...
3.  **Comprehensive Temporal Splits (Table VIII & IX):**
    *   **Location:** [paper/appendix/appendix_a_sensitivity.tex](file:///c:/TRINH/Sparse-Concept and Calibration/sparse-calibration-kt/paper/appendix/appendix_a_sensitivity.tex#L11)
