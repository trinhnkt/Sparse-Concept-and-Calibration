...
### [table_iii_overall_results_updated.tex](file:///c:/TRINH/Sparse-Concept and Calibration/sparse-calibration-kt/paper/tables/table_iii_overall_results_updated.tex) (Table III: Overall Results)
...
### [table_iv_bucket_performance_updated.tex](file:///c:/TRINH/Sparse-Concept and Calibration/sparse-calibration-kt/paper/tables/table_iv_bucket_performance_updated.tex) (Table IV: Stratum Performance)
...
### [table_v_calibration_by_bucket_updated.tex](file:///c:/TRINH/Sparse-Concept and Calibration/sparse-calibration-kt/paper/tables/table_v_calibration_by_bucket_updated.tex) (Table V: Calibration Breakdown)
...
### [table_vi_cold_start_temporal_updated.tex](file:///c:/TRINH/Sparse-Concept and Calibration/sparse-calibration-kt/paper/tables/table_vi_cold_start_temporal_updated.tex) (Table VI: Cold-Start Temporal Diagnostics)
...
### [table_delong_overall_auc.tex](file:///c:/TRINH/Sparse-Concept and Calibration/sparse-calibration-kt/paper/tables/table_delong_overall_auc.tex) (Table VII / Pairwise DeLong Tests)
...
### Appendix Tables
- **Table VIII**: [table_viii_updated.tex](file:///c:/TRINH/Sparse-Concept and Calibration/sparse-calibration-kt/paper/tables/table_viii_updated.tex) (Overall Temporal results).
- **Table IX**: [table_ix_updated.tex](file:///c:/TRINH/Sparse-Concept and Calibration/sparse-calibration-kt/paper/tables/table_ix_updated.tex) (Temporal Strata performance).
...
- **Dense KCs**: [junyi_temporal_simplekt_dense.pdf](file:///c:/TRINH/Sparse-Concept and Calibration/sparse-calibration-kt/paper/figures/junyi_temporal_simplekt_dense.pdf) ($N = 3,072,767$, $\text{ECE} = 0.2267$). The curve is well-calibrated and aligns near the diagonal.
- **Very Sparse KCs**: [junyi_temporal_simplekt_very_sparse.pdf](file:///c:/TRINH/Sparse-Concept and Calibration/sparse-calibration-kt/paper/figures/junyi_temporal_simplekt_very_sparse.pdf) ($N = 2,545$, $\text{ECE} = 0.3084$). Displays non-linear calibration deviation in low-frequency strata.
- **Figure 3 Composite**: [figure3_reliability_diagrams_updated.pdf](file:///c:/TRINH/Sparse-Concept and Calibration/sparse-calibration-kt/paper/figures/figure3_reliability_diagrams_updated.pdf) (the final composite diagram showing the Very Sparse strata curve).

---

## 4. Verification & Consistency Check
We conducted a complete pre-submission check (T16) to ensure that the manuscript text, figures, tables, and reports are fully aligned. The paper source code is Overleaf-ready and compiles cleanly, and the preview PDF [P0_final_presubmission_check.pdf](file:///c:/TRINH/Sparse-Concept and Calibration/sparse-calibration-kt/paper/P0_final_presubmission_check.pdf) accurately reflects all T14 table and figure updates.
